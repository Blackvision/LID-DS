...
def main(args_scenario, args_base_path, args_result_path, args_featureset):
    ### feature config:
    # general
    ...
    feature_set = int(args_featureset)
...
if __name__ == '__main__':
    try:
        ...
        parser.add_argument('-r', dest='result_path', action='store', type=str, required=True,
                            help='result path')
        parser.add_argument('-n', dest='featureset', action='store', type=str, required=True,
                            help='featureset')

        args = parser.parse_args()
        print(f"Start with scenario {args.scenario}")

        main(args.scenario, args.base_path, args.result_path, args.featureset)
